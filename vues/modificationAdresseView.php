    ...
    <form action="controleur/modifie_adresse.php" method="POST">
      ...
      <table align="center">
        <tr>
          ...
          <td style="width:70%"><input type="text" name="numero_et_rue" maxlength="50" value="<?php echo $adresse_a_modifier->numero_et_rue() ?>"></td>
        </tr>
        <tr>
          <td style="width:30%">Code postal</td>
          <td style="width:70%"><input type="text" name="code_postal" maxlength="50" value="<?php echo $adresse_a_modifier->code_postal() ?>"></td>
        </tr>
        <tr>
          <td style="width:30%">Ville</td>
          <td style="width:70%"><input type="text" name="ville" maxlength="50" value="<?php echo $adresse_a_modifier->ville() ?>"></td>
        </tr>
        <tr>
          <td style="width:30%">Pays</td>
          <td style="width:70%"><input type="text" name="pays" maxlength="50" value="<?php echo $adresse_a_modifier->pays() ?>"></td>
        </tr>
        <tr>
